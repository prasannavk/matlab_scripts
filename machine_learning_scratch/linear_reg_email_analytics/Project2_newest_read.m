filename = 'HillstromData_NewFeatNoemail.csv';
data = csvread(filename,1,0,[1,0,21300,41]);
...
%       With regularization        
        smpl=randsample(idx_eg,miniBatchSize);
...
[m,n] = size(data);
test_data = horzcat(ones((m-20000),1),data(20001:m,1:35));
