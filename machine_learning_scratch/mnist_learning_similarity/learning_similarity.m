...
for i=2:m_tr
    ...
    temp_train_new=temp_mat.*buff;%%Just 500 of the interclass combinations are selected
    temp_train_new(:,1)=comp_vector([idx; sampled_idx_inter_class]);
    %matrix containing dot products for each i
